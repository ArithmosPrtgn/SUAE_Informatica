...
Esse projeto é da disciplina Projeto de Extensão I e II do ano de 2026 com os professores responsáveis sendo Lorena T Boechat e Marcos Celso Rodrigues
 ...
 E esse HTML tem como objetivo ajudar estudantes da área de informática, oferecendo materiais variados para auxiliar nos estudos, além de servir como apoio para profissionais ou iniciantes que desejam aprender o básico sobre tecnologia e informática.

O site ainda está em desenvolvimento, mas a proposta do projeto é criar um material completo contendo:

* Linguagens de Programação
* Informações e histórias sobre Hardwares
* Informações e tutoriais de Sistemas Operacionais
* Exercícios práticos para desenvolver conhecimentos em informática
